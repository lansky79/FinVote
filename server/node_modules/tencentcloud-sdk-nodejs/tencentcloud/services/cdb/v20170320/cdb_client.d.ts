...
export declare class Client extends AbstractClient {
     ...
     */
    ModifyRoGroupVipVport(req: ModifyRoGroupVipVportRequest, cb?: (error: string, rep: ModifyRoGroupVipVportResponse) => void): Promise<ModifyRoGroupVipVportResponse>;
    /**
...
使用时需要注意：可能存在单条错误日志太大，导致整个http请求的回包太大，进而引发接口超时。一旦发生超时，建议您缩小查询时的Limit参数值，从而降低包的大小，让接口能够及时返回内容。
     ...
     */
    DescribeCPUExpandStrategyInfo(req: DescribeCPUExpandStrategyInfoRequest, cb?: (error: string, rep: DescribeCPUExpandStrategyInfoResponse) => void): Promise<DescribeCPUExpandStrategyInfoResponse>;
    /**
...
4. 支持创建主实例、灾备实例和只读实例；
     ...
     */
    DescribeInstancePasswordComplexity(req: DescribeInstancePasswordComplexityRequest, cb?: (error: string, rep: DescribeInstancePasswordComplexityResponse) => void): Promise<DescribeInstancePasswordComplexityResponse>;
    /**
...
说明：参数模板为公共组件，配置完成后全地域生效。接口调用配置地域可选择广州、新加坡。
     ...
     */
    ModifyDBInstanceModes(req: ModifyDBInstanceModesRequest, cb?: (error: string, rep: ModifyDBInstanceModesResponse) => void): Promise<ModifyDBInstanceModesResponse>;
    /**
