...
参考的AddCompliancePolicyItemToWhitelist，除输入字段外，其它应该是一致的，如果有不同可能是定义的不对
     ...
     * 创建集群接入
     */
    CreateClusterAccess(req: CreateClusterAccessRequest, cb?: (error: string, rep: CreateClusterAccessResponse) => void): Promise<CreateClusterAccessResponse>;
    /**
     * 新增逃逸白名单
     */
...
从白名单中删除将指定的检测项。
     ...
     * 编辑恶意请求事件状态
     */
    ModifyRiskDnsEventStatus(req: ModifyRiskDnsEventStatusRequest, cb?: (error: string, rep: ModifyRiskDnsEventStatusResponse) => void): Promise<ModifyRiskDnsEventStatusResponse>;
    /**
     * 查询安全日志接入列表
     */
