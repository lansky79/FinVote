...
export declare class Client extends AbstractClient {
     ...
     * 获取发布渠道列表
     */
    ListChannel(req: ListChannelRequest, cb?: (error: string, rep: ListChannelResponse) => void): Promise<ListChannelResponse>;
    /**
     * 导出属性标签
     */
