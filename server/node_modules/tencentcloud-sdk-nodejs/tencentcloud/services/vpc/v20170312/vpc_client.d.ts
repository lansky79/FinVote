...
import { GenerateVpnConnectionDefaultHealthCheckIpRequest, CreateNetworkAclResponse, ModifyAddressTemplateAttributeResponse, DisassociateDhcpIpWithAddressIpRequest, LockCcnsRequest, ResumeSnapshotInstanceRequest, CreateRoutesRequest, DescribeHaVipsResponse, DeleteServiceTemplateResponse, CreateServiceTemplateRequest, CreateVpcPeeringConnectionRequest, ModifyGlobalRoutesRequest, ResetTrafficMirrorFilterRequest, DescribeBandwidthPackageResourcesRequest, DescribeVpnConnectionsRequest, CreateAssistantCidrRequest, RejectVpcPeeringConnectionRequest, DescribeNetworkInterfacesRequest, DescribeVpcLimitsRequest, ReleaseIp6AddressesBandwidthResponse, DescribeVpcIpv6AddressesRequest, DescribeRoutesResponse, ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse, ModifyIp6RuleResponse, DeleteCdcLDCXListResponse, SetVpnGatewaysRenewFlagRequest, ModifyCcnRegionBandwidthLimitsTypeResponse, DescribeVpnGatewaysResponse, ModifyNetworkAclQuintupleEntriesRequest, CreateDhcpIpResponse, DescribeIpGeolocationDatabaseUrlResponse, DeleteVpnGatewaySslServerResponse, CreateHighPriorityRouteTableResponse, DescribeIpGeolocationInfosRequest, AddTemplateMemberResponse, ReplaceHighPriorityRouteTableAssociationRequest, CreateDefaultSecurityGroupRequest, CreateSnapshotPoliciesResponse, DescribeServiceTemplateGroupsResponse, DescribeVpcEndPointRequest, DescribeServiceTemplateInstancesRequest, DeleteRoutePolicyEntriesRequest, DetachClassicLinkVpcRequest, DescribeBandwidthPackageBillUsageResponse, DeleteBandwidthPackageResponse, ModifyNatGatewayAttributeRequest, DescribeLocalGatewayRequest, DescribeVpcLimitsResponse, CreatePrivateNatGatewayDestinationIpPortTranslationNatRuleRequest, DescribeReserveIpAddressesRequest, AddBandwidthPackageResourcesRequest, ReplaceRoutePolicyEntriesRequest, AssignIpv6SubnetCidrBlockRequest, DeleteVpnGatewaySslClientResponse, DescribeCrossBorderComplianceRequest, CreateVpcResponse, ModifyVpnGatewaySslClientCertRequest, ModifyNetworkAclEntriesRequest, ReplaceRoutePolicyAssociationsResponse, DescribeVpcPrivateIpAddressesRequest, DescribeGlobalRoutesRequest, StopTrafficMirrorResponse, DeleteHaVipResponse, DeleteVpnGatewaySslClientRequest, DescribeBandwidthPackageBillUsageRequest, DescribeRouteTableSelectionPoliciesResponse, UnassignIpv6AddressesResponse, CreateIp6TranslatorsResponse, DescribeFlowLogsRequest, CloneSecurityGroupRequest, AssociateNatGatewayAddressRequest, DescribeFlowLogsResponse, ModifyHighPriorityRouteAttributeResponse, CreateVpnGatewaySslServerRequest, CreateVpcEndPointRequest, ModifyBandwidthPackageAttributeRequest, TransformAddressResponse, DisassociateNetworkInterfaceSecurityGroupsRequest, DeleteNetworkAclEntriesRequest, DescribeHighPriorityRoutesRequest, ModifyFlowLogAttributeRequest, UnassignIpv6SubnetCidrBlockResponse, ReplaceHighPriorityRoutesResponse, ModifyVpcEndPointServiceAttributeRequest, DescribeIpGeolocationInfosResponse, DescribeVpcTaskResultRequest, AssociateNetworkAclSubnetsResponse, DeletePrivateNatGatewayTranslationNatRuleRequest, DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest, ResetRoutesRequest, CheckDefaultSubnetRequest, CheckNetDetectStateRequest, DescribeAddressTemplateInstancesRequest, ModifyCustomerGatewayAttributeRequest, DescribeBandwidthPackageBandwidthRangeResponse, DeleteVpcEndPointServiceWhiteListRequest, DescribeTrafficMirrorsRequest, DetachSnapshotInstancesResponse, DetachNetworkInterfaceResponse, DeleteVpcEndPointServiceRequest, DeleteCcnResponse, DescribeCcnAttachedInstancesRequest, AttachSnapshotInstancesResponse, DescribeNatGatewaySourceIpTranslationNatRulesRequest, DescribeNatGatewaysRequest, ModifyFlowLogAttributeResponse, InquiryPriceRenewVpnGatewayResponse, DeleteReserveIpAddressesResponse, ResetRoutesResponse, DescribePrivateNatGatewayRegionsResponse, ReplaceSecurityGroupPoliciesResponse, DescribeDirectConnectGatewaysRequest, DescribeSpecificTrafficPackageUsedDetailsResponse, DescribeIPv6AddressesResponse, AttachSnapshotInstancesRequest, ModifyIp6TranslatorResponse, CreateVpcEndPointServiceWhiteListResponse, DescribeInstanceJumboResponse, AssociateInstancesToCcnRouteTableRequest, UnlockCcnBandwidthsRequest, DeleteIp6TranslatorsResponse, DescribeNatGatewaySourceIpTranslationNatRulesResponse, DescribeHighPriorityRouteTablesResponse, DescribeRouteConflictsResponse, AcceptAttachCcnInstancesRequest, CreateNetworkAclQuintupleEntriesResponse, DescribeGatewayFlowMonitorDetailResponse, ResetTrafficMirrorTargetResponse, RemoveBandwidthPackageResourcesResponse, DeleteFlowLogRequest, DownloadVpnGatewaySslClientCertResponse, DescribeSnapshotFilesRequest, HaVipDisassociateAddressIpResponse, ResetRoutePolicyAssociationsResponse, DisassociateVpcEndPointSecurityGroupsRequest, DescribeTaskResultRequest, ModifyAddressInternetChargeTypeResponse, SetCcnRegionBandwidthLimitsResponse, CreateRoutePolicyResponse, ModifyIPv6AddressesBandwidthRequest, DescribeAccountAttributesResponse, ModifyNetworkAclQuintupleEntriesResponse, AssignIpv6CidrBlockRequest, CreateSecurityGroupPoliciesResponse, UnassignIpv6CidrBlockResponse, ModifyVpnGatewayRoutesRequest, HaVipAssociateAddressIpRequest, DisassociateNatGatewayAddressResponse, DeleteRoutesResponse, ModifyDhcpIpAttributeRequest, DescribeSecurityGroupAssociationStatisticsResponse, ModifyAssistantCidrResponse, ModifyHighPriorityRouteECMPAlgorithmResponse, DescribeVpcEndPointServiceResponse, ModifyNetworkAclEntriesResponse, DescribeCdcNetPlanesResponse, ModifyVpcEndPointAttributeResponse, DescribeFlowLogRequest, DescribeTenantCcnsRequest, DescribeIp6AddressesRequest, CreateRoutePolicyRequest, DeleteRoutePolicyAssociationsResponse, AddIp6RulesRequest, DeleteVpcEndPointServiceResponse, ModifyAddressesRenewFlagRequest, ModifyGlobalRoutesResponse, AssignPrivateIpAddressesResponse, DescribeSecurityGroupsRequest, RefreshDirectConnectGatewayRouteToNatGatewayRequest, DescribeNatGatewayDestinationIpPortTranslationNatRulesRequest, ModifyNetworkAclAttributeResponse, ModifyIPv6AddressesAttributesRequest, CreateVpnGatewayRoutesRequest, DisassociateNetworkAclSubnetsResponse, ReplaceRoutePolicyEntriesResponse, ModifyAddressInternetChargeTypeRequest, ModifyIp6AddressesBandwidthRequest, DisableVpnGatewaySslClientCertResponse, CreateLocalGatewayRequest, DescribeDirectConnectGatewaysResponse, AddBandwidthPackageResourcesResponse, DeleteHighPriorityRouteTablesRequest, CreateSecurityGroupWithPoliciesResponse, DeleteAddressTemplateResponse, MigrateBandwidthPackageResourcesRequest, ModifySubnetAttributeResponse, ResetNatGatewayConnectionRequest, ResetHighPriorityRoutesResponse, ModifyCcnAttachedInstancesAttributeRequest, DescribeNetworkAccountTypeRequest, DeleteAddressTemplateRequest, CreateNatGatewaySourceIpTranslationNatRuleRequest, TransformAddressRequest, ReplaceDirectConnectGatewayCcnRoutesRequest, DescribeRoutePolicyEntriesResponse, ModifyAddressTemplateAttributeRequest, CreateCdcLDCXListRequest, ModifyRoutePolicyAttributeRequest, CreateNatGatewayResponse, DescribeVpnGatewaySslClientsRequest, ModifyDirectConnectGatewayAttributeRequest, ModifyRouteTableSelectionPoliciesRequest, RejectVpcPeeringConnectionResponse, ClearRouteTableSelectionPoliciesRequest, CreateTrafficPackagesResponse, ModifySecurityGroupAttributeRequest, DescribeVpnGatewaySslServersRequest, ModifyNetDetectRequest, SetVpnGatewaysRenewFlagResponse, AssociateInstancesToCcnRouteTableResponse, DescribeNetDetectStatesResponse, DeleteVpnGatewaySslServerRequest, AllocateIp6AddressesBandwidthResponse, DescribeNetDetectStatesRequest, DescribeRouteConflictsRequest, DescribeFlowLogResponse, DeleteRoutePolicyEntriesResponse, DescribeBandwidthPackagesRequest, DeleteDirectConnectGatewayCcnRoutesResponse, DescribeAssistantCidrResponse, DescribeHaVipsRequest, UpdateTrafficMirrorDirectionResponse, DescribeRouteTableSelectionPoliciesRequest, CreateVpnConnectionRequest, ResetTrafficMirrorFilterResponse, ModifyIpv6AddressesAttributeResponse, DescribeTrafficPackagesRequest, DeleteSecurityGroupPoliciesRequest, DescribeCcnsRequest, DisableRoutesResponse, DescribeNetDetectsRequest, CreateAddressTemplateGroupRequest, AssociateIPv6AddressRequest, DescribeCustomerGatewayVendorsResponse, DeleteCdcLDCXListRequest, DeleteSubnetResponse, DeleteGlobalRoutesRequest, CreateVpnGatewayResponse, DescribeNatGatewayDestinationIpPortTranslationNatRulesResponse, AllocateIp6AddressesBandwidthRequest, DeleteRoutePolicyResponse, DescribeVpcIpv6AddressesResponse, ResetAttachCcnInstancesResponse, RejectAttachCcnInstancesRequest, DescribeTrafficQosPolicyRequest, ModifyCcnRegionBandwidthLimitsTypeRequest, DescribeRouteListResponse, DescribeVpcResourceDashboardRequest, ModifyIp6RuleRequest, ReplaceRouteTableAssociationRequest, AssociateNetworkAclSubnetsRequest, ResetRoutePolicyEntriesResponse, ModifyVpnGatewaySslServerResponse, AdjustPublicAddressResponse, DescribeVpnConnectionsResponse, RenewVpnGatewayRequest, AssociateIPv6AddressResponse, ResumeSnapshotInstanceResponse, DescribeCdcNetPlanesRequest, DescribePrivateNatGatewayRegionsRequest, DescribeSnapshotPoliciesRequest, DeleteTrafficPackagesRequest, NotifyRoutesRequest, DeleteVpcRequest, DeleteCcnRouteTablesRequest, ModifyServiceTemplateAttributeResponse, DescribeCcnsResponse, ModifyCdcNetPlaneAttributeRequest, CreateCdcLDCXListResponse, CreateSubnetResponse, DescribeAddressBandwidthRangeResponse, DescribeSecurityGroupPoliciesResponse, DescribeGatewayFlowQosResponse, ModifySecurityGroupPoliciesRequest, ModifyPrivateNatGatewayAttributeResponse, AssociateDhcpIpWithAddressIpRequest, ModifyVpcPeeringConnectionRequest, ReplaceRoutesRequest, CreateCustomerGatewayResponse, CreateTrafficMirrorResponse, WithdrawNotifyRoutesRequest, DescribeSubnetResourceDashboardRequest, CreateRoutePolicyEntriesRequest, DeleteServiceTemplateGroupResponse, StartTrafficMirrorResponse, DeleteVpnConnectionResponse, DescribeVpnGatewaySslClientsResponse, ReleaseIPv6AddressesResponse, CreateCcnResponse, EnableCcnRoutesRequest, DescribeCcnAttachedInstancesResponse, DescribeIp6TranslatorsRequest, CreateSubnetsResponse, DescribeGatewayFlowMonitorDetailRequest, ResetTrafficMirrorSrcsRequest, InquiryPriceCreateVpnGatewayResponse, DescribeSecurityGroupLimitsResponse, DescribeCcnRouteTableInputPolicysResponse, ModifyBandwidthPackageAttributeResponse, CreateVpnGatewaySslServerResponse, ModifySubnetAttributeRequest, DisassociateIPv6AddressRequest, CreateHighPriorityRouteTableRequest, DeleteNetworkAclRequest, CreateHighPriorityRoutesRequest, CloneSecurityGroupResponse, ModifyIp6TranslatorRequest, CreateVpnConnectionResponse, DescribeCdcUsedIdcVlanResponse, AssignIpv6AddressesRequest, CreateServiceTemplateGroupResponse, DisableSnapshotPoliciesRequest, ModifyPrivateNatGatewayDestinationIpPortTranslationNatRuleRequest, ReplaceHighPriorityRoutesRequest, DeleteHighPriorityRoutesResponse, ReplaceSecurityGroupPolicyRequest, ModifyVpcEndPointServiceAttributeResponse, DeletePrivateNatGatewayDestinationIpPortTranslationNatRuleResponse, DescribeReserveIpAddressesResponse, DescribeSnapshotFilesResponse, CreateFlowLogResponse, CreateNetworkAclEntriesRequest, DeleteCustomerGatewayResponse, CreateVpnGatewayRoutesResponse, CreateNetDetectRequest, CreateAddressTemplateResponse, CreateNatGatewayDestinationIpPortTranslationNatRuleResponse, DeleteAddressTemplateGroupRequest, CreateVpnGatewaySslClientResponse, DescribeNetworkInterfaceLimitRequest, ModifyVpnGatewayRoutesResponse, DescribeIp6AddressesResponse, ModifyRouteTableAttributeRequest, ModifyDirectConnectGatewayAttributeResponse, DescribeVpnGatewaysRequest, DescribeInstanceJumboRequest, CheckGatewayFlowMonitorResponse, DescribeAddressTemplatesResponse, ModifyIp6AddressesBandwidthResponse, CreateSubnetsRequest, DescribeVpcEndPointServiceRequest, DisableSnapshotPoliciesResponse, ResetTrafficMirrorSrcsResponse, ModifyServiceTemplateAttributeRequest, ModifyPrivateNatGatewayAttributeRequest, AssociateAddressResponse, ModifyCcnAttachedInstancesAttributeResponse, UnassignIpv6SubnetCidrBlockRequest, CreateNetworkAclRequest, DescribeAddressesRequest, DescribeVpcsRequest, DescribeSecurityGroupPoliciesRequest, ModifyIPv6AddressesAttributesResponse, InquiryPriceRenewAddressesRequest, CreateSecurityGroupResponse, DisassociateNetworkInterfaceSecurityGroupsResponse, DescribeIp6TranslatorQuotaRequest, DescribeHighPriorityRoutesResponse, DescribePrivateNatGatewayLimitsResponse, DescribeNetworkInterfaceLimitResponse, AssignIpv6CidrBlockResponse, CreateCcnRequest, DeleteTemplateMemberResponse, ModifyNatGatewaySourceIpTranslationNatRuleRequest, RemoveIp6RulesRequest, CreatePrivateNatGatewayTranslationNatRuleRequest, DescribeIpGeolocationDatabaseUrlRequest, DescribeGlobalRoutesResponse, DescribeNetworkAclQuintupleEntriesRequest, DescribeSnapshotPoliciesResponse, DescribeAddressTemplateGroupInstancesRequest, DescribeCcnRouteTableBroadcastPolicysResponse, EnableRoutesResponse, HaVipAssociateAddressIpResponse, DeletePrivateNatGatewayTranslationAclRuleResponse, DescribeSpecificTrafficPackageUsedDetailsRequest, ModifyRoutePolicyAttributeResponse, DeleteVpnConnectionRequest, DescribePrivateNatGatewayDestinationIpPortTranslationNatRulesRequest, DescribeDhcpIpsRequest, DescribeAssistantCidrRequest, RenewVpnGatewayResponse, DescribeCcnRouteTablesResponse, DeleteDirectConnectGatewayResponse, DescribeIPv6AddressesRequest, ResetVpnGatewayInternetMaxBandwidthRequest, RemoveIp6RulesResponse, DescribeAddressTemplateInstancesResponse, DescribeProductQuotaResponse, HaVipDisassociateAddressIpRequest, DescribeSgSnapshotFileContentResponse, ClearRouteTableSelectionPoliciesResponse, DescribeBandwidthPackageResourcesResponse, DescribeCrossBorderComplianceResponse, ModifyVpnGatewayAttributeResponse, AllocateIPv6AddressesRequest, AssociateDirectConnectGatewayNatGatewayResponse, DescribeVpcResourceDashboardResponse, DescribeVpnGatewayCcnRoutesRequest, DisassociateDirectConnectGatewayNatGatewayResponse, CreateServiceTemplateGroupRequest, CreateNetworkAclQuintupleEntriesRequest, DeleteHighPriorityRoutesRequest, DescribeClassicLinkInstancesResponse, ModifyCdcLDCXAttributeRequest, EnableVpnGatewaySslClientCertRequest, DeleteReserveIpAddressesRequest, DescribeVpnGatewayCcnRoutesResponse, DetachCcnInstancesRequest, ModifyVpcEndPointServiceWhiteListRequest, DescribeTenantCcnsResponse, MigrateNetworkInterfaceResponse, DeleteDirectConnectGatewayRequest, CreateNatGatewaySourceIpTranslationNatRuleResponse, DeleteNatGatewaySourceIpTranslationNatRuleResponse, DescribeNetworkAccountTypeResponse, DescribeRoutesRequest, ModifyHighPriorityRouteTableAttributeRequest, CreateVpcEndPointServiceRequest, DescribePrivateNatGatewaysRequest, DescribePrivateNatGatewayTranslationAclRulesResponse, CreateNetworkInterfaceRequest, DeleteTrafficMirrorResponse, DescribePrivateNatGatewayTranslationAclRulesRequest, CreateDirectConnectGatewayRequest, DescribeNetworkAclsRequest, DescribeNetworkAclQuintupleEntriesResponse, DescribeSubnetsRequest, CreateSubnetRequest, DownloadCustomerGatewayConfigurationRequest, DeleteBandwidthPackageRequest, DeleteTemplateMemberRequest, ModifyAddressesBandwidthResponse, RejectAttachCcnInstancesResponse, DescribeCcnRouteTableInputPolicysRequest, ModifySnapshotPoliciesResponse, ResetRoutePolicyEntriesRequest, InquiryPriceRenewAddressesResponse, ReplaceCcnRouteTableInputPolicysResponse, DeleteCdcNetPlanesResponse, CreateRoutePolicyAssociationsRequest, RenewAddressesResponse, ModifyVpnGatewaySslServerRequest, DescribeCcnRoutesRequest, GenerateVpnConnectionDefaultHealthCheckIpResponse, CheckTrafficMirrorResponse, CreateAndAttachNetworkInterfaceRequest, DeleteVpcEndPointResponse, DeleteDhcpIpResponse, DeleteSecurityGroupRequest, DeleteNetDetectResponse, AllocateAddressesRequest, DeleteAssistantCidrResponse, DescribeDhcpIpsResponse, UnassignIpv6CidrBlockRequest, CreateGlobalRoutesRequest, ResetHighPriorityRoutesRequest, ModifyAssistantCidrRequest, CreateReserveIpAddressesResponse, CheckTrafficMirrorRequest, AssociateDhcpIpWithAddressIpResponse, ModifyTrafficMirrorAttributeResponse, DescribeNatGatewayFlowMonitorDetailRequest, ModifyGatewayFlowQosResponse, ModifyNetworkInterfaceQosResponse, DescribeNatGatewayFlowMonitorDetailResponse, ModifySecurityGroupAttributeResponse, AssociateDirectConnectGatewayNatGatewayRequest, DeletePrivateNatGatewayDestinationIpPortTranslationNatRuleRequest, CreatePrivateNatGatewayTranslationNatRuleResponse, ModifyAddressAttributeResponse, AttachClassicLinkVpcRequest, CreateVpnGatewaySslClientRequest, DescribeServiceTemplateGroupInstancesResponse, ReplaceRoutePolicyAssociationsRequest, CreateCdcNetPlanesResponse, DescribeVpnGatewaySslServersResponse, ModifyAddressesRenewFlagResponse, DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse, DeleteVpnGatewayRequest, ReplaceRouteTableAssociationResponse, AttachCcnInstancesRequest, ModifyBandwidthPackageBandwidthResponse, DeleteRoutePolicyAssociationsRequest, DescribeLocalGatewayResponse, DeleteNatGatewayRequest, ModifyBandwidthPackageBandwidthRequest, ModifyCustomerGatewayAttributeResponse, CreatePrivateNatGatewayTranslationAclRuleResponse, DeletePrivateNatGatewayTranslationNatRuleResponse, AssignIpv6SubnetCidrBlockResponse, CreateVpcEndPointResponse, CreateReserveIpAddressesRequest, DescribeCcnRegionBandwidthLimitsResponse, ModifyTemplateMemberRequest, DescribeDirectConnectGatewayCcnRoutesRequest, DisableCcnRoutesRequest, EnableSnapshotPoliciesRequest, ModifyNatGatewayAttributeResponse, DescribeAddressesResponse, DescribePrivateNatGatewayTranslationNatRulesRequest, DeleteCcnRouteTablesResponse, GetCcnRegionBandwidthLimitsRequest, DescribeVpcEndPointResponse, DescribeCustomerGatewayVendorsRequest, DetachSnapshotInstancesRequest, ReplaceHighPriorityRouteTableAssociationResponse, AssociateHaVipInstanceResponse, ResetVpnGatewayInternetMaxBandwidthResponse, LockCcnBandwidthsRequest, DescribeCrossBorderFlowMonitorRequest, DescribeVpnGatewayRoutesResponse, ModifyCcnRouteTablesResponse, DescribeNetworkAclsResponse, DescribeNatGatewayDirectConnectGatewayRouteRequest, DeleteFlowLogResponse, ResetRoutePolicyAssociationsRequest, CreatePrivateNatGatewayRequest, CreateCcnRouteTablesRequest, CreateDefaultVpcResponse, ModifyVpcAttributeResponse, ModifyVpnConnectionAttributeResponse, DescribePrivateNatGatewayTranslationNatRulesResponse, ModifyIpv6AddressesAttributeRequest, DescribeUsedIpAddressRequest, DeleteRouteTableResponse, DescribeVpcInstancesResponse, AllocateIPv6AddressesResponse, DeleteDirectConnectGatewayCcnRoutesRequest, CheckNetDetectStateResponse, ModifyNatGatewaySourceIpTranslationNatRuleResponse, CreateDefaultVpcRequest, CreateNatGatewayDestinationIpPortTranslationNatRuleRequest, CreateFlowLogRequest, InquirePriceCreateDirectConnectGatewayRequest, AttachNetworkInterfaceResponse, DisassociateNatGatewayAddressRequest, CreateHighPriorityRoutesResponse, CreateSnapshotPoliciesRequest, DescribeRouteTablesRequest, DescribeVpcPeeringConnectionsResponse, CreateHaVipResponse, DescribeSecurityGroupReferencesRequest, DescribeTemplateLimitsResponse, CheckDefaultSubnetResponse, EnableSnapshotPoliciesResponse, DescribeVpcPrivateIpAddressesResponse, ModifyReserveIpAddressRequest, DisableRoutesRequest, DescribeAddressTemplateGroupInstancesResponse, DescribeRouteTableAssociatedInstancesRequest, ReleaseIPv6AddressesRequest, DisassociateIPv6AddressResponse, CheckGatewayFlowMonitorRequest, SetCcnRegionBandwidthLimitsRequest, DescribeServiceTemplateInstancesResponse, CreateDirectConnectGatewayCcnRoutesRequest, ModifyGatewayFlowQosRequest, StopTrafficMirrorRequest, ModifyHighPriorityRouteTableAttributeResponse, CreateDirectConnectGatewayCcnRoutesResponse, CreateRouteTableRequest, DescribeServiceTemplateGroupInstancesRequest, StartTrafficMirrorRequest, MigrateNetworkInterfaceRequest, DescribeCustomerGatewaysRequest, ModifyReserveIpAddressResponse, DeleteLocalGatewayRequest, ModifySnapshotPoliciesRequest, ModifyAddressAttributeRequest, DeleteAssistantCidrRequest, DisableVpnGatewaySslClientCertRequest, CreateRouteTableResponse, DescribeNatGatewayDirectConnectGatewayRouteResponse, EnableVpcEndPointConnectResponse, CreateNetDetectResponse, InquiryPriceAllocateAddressesResponse, DeleteCcnRequest, ModifyLocalGatewayResponse, AssociateNetworkInterfaceSecurityGroupsResponse, EnableFlowLogsRequest, ModifyVpnGatewayAttributeRequest, CreateNatGatewayRequest, DeleteNetDetectRequest, UnassignIpv6AddressesRequest, ModifyPrivateNatGatewayTranslationAclRuleRequest, CreateTrafficPackagesRequest, CreateAndAttachNetworkInterfaceResponse, ModifyCdcNetPlaneAttributeResponse, ModifyCcnAttributeRequest, DeleteSecurityGroupPoliciesResponse, DisassociateDhcpIpWithAddressIpResponse, CreateVpcEndPointServiceResponse, ModifyNetworkAclAttributeRequest, CreateGlobalRoutesResponse, CreatePrivateNatGatewayTranslationAclRuleRequest, DeleteVpnGatewayResponse, InquiryPriceModifyAddressesBandwidthResponse, UnassignPrivateIpAddressesResponse, DescribeVpcPeeringConnectionsRequest, ModifyAddressesBandwidthRequest, EnableVpcEndPointConnectRequest, EnableGatewayFlowMonitorResponse, ModifyPrivateNatGatewayDestinationIpPortTranslationNatRuleResponse, DescribePrivateNatGatewayDestinationIpPortTranslationNatRulesResponse, DescribeBandwidthPackageBandwidthRangeRequest, DescribeRouteTablesResponse, DeleteDhcpIpRequest, AllocateAddressesResponse, MigrateBandwidthPackageResourcesResponse, DescribeCdcUsedIdcVlanRequest, ModifyVpcAttributeRequest, DescribeIp6TranslatorsResponse, CreateSecurityGroupPoliciesRequest, DeleteVpcPeeringConnectionRequest, CreateBandwidthPackageRequest, DescribeRouteTableAssociatedInstancesResponse, ModifyRouteTableAttributeResponse, ModifyIPv6AddressesBandwidthResponse, DescribeSecurityGroupReferencesResponse, AddIp6RulesResponse, CreateAddressTemplateGroupResponse, DescribeBandwidthPackageQuotaResponse, DescribeIp6TranslatorQuotaResponse, DeleteServiceTemplateGroupRequest, DeleteNatGatewayResponse, ReplaceSecurityGroupPoliciesRequest, DeletePrivateNatGatewayRequest, AdjustPublicAddressRequest, CreateDirectConnectGatewayResponse, AttachCcnInstancesResponse, ModifyVpcEndPointAttributeRequest, DescribeCcnRouteTablesRequest, DescribeTaskResultResponse, DisassociateNetworkAclSubnetsRequest, ModifyAddressTemplateGroupAttributeRequest, ModifyVpcPeeringConnectionResponse, ModifyServiceTemplateGroupAttributeRequest, ReturnNormalAddressesResponse, DeleteVpcEndPointRequest, InquiryPriceAllocateAddressesRequest, ModifyHighPriorityRouteAttributeRequest, InquirePriceCreateDirectConnectGatewayResponse, DeleteIp6TranslatorsRequest, CheckAssistantCidrRequest, UpdateTrafficMirrorAllFilterRequest, DescribeTrafficMirrorsResponse, DeleteVpcPeeringConnectionResponse, DeleteSnapshotPoliciesRequest, DeletePrivateNatGatewayResponse, DisableFlowLogsResponse, DescribeSubnetsResponse, DescribeCustomerGatewaysResponse, CheckAssistantCidrResponse, DescribeVpcTaskResultResponse, InquiryPriceRenewVpnGatewayRequest, EnableCcnRoutesResponse, ResetVpnConnectionResponse, DescribePrivateNatGatewaysResponse, ModifyVpnGatewayCcnRoutesResponse, DetachCcnInstancesResponse, ModifyServiceTemplateGroupAttributeResponse, DeleteNetworkAclQuintupleEntriesRequest, DeleteSubnetRequest, CreateCcnRouteTablesResponse, DescribeAddressTemplateGroupsRequest, MigratePrivateIpAddressResponse, DeleteRoutePolicyRequest, DisassociateVpcEndPointSecurityGroupsResponse, DeleteSnapshotPoliciesResponse, AssociateNatGatewayAddressResponse, RemoveBandwidthPackageResourcesRequest, ModifyVpnConnectionAttributeRequest, DeleteNetworkInterfaceRequest, InquiryPriceResetVpnGatewayInternetMaxBandwidthResponse, ReplaceCcnRouteTableBroadcastPolicysResponse, DescribeVpcEndPointServiceWhiteListRequest, DescribeTemplateLimitsRequest, DeleteAddressTemplateGroupResponse, ModifyNetworkInterfaceQosRequest, ModifyLocalGatewayRequest, DeleteHaVipRequest, CreateLocalGatewayResponse, ModifyHighPriorityRouteECMPAlgorithmRequest, MigratePrivateIpAddressRequest, AssignPrivateIpAddressesRequest, DescribeCcnRouteTableBroadcastPolicysRequest, RefreshDirectConnectGatewayRouteToNatGatewayResponse, DescribeBandwidthPackagesResponse, DeleteRouteTableRequest, AssociateHaVipInstanceRequest, DescribeCdcLDCXListResponse, CreateVpnGatewayRequest, DescribeVpcInstancesRequest, DeleteVpcEndPointServiceWhiteListResponse, DescribeServiceTemplatesResponse, AcceptVpcPeeringConnectionResponse, DescribeSgSnapshotFileContentRequest, CreateBandwidthPackageResponse, CreateNetworkAclEntriesResponse, ResetVpnConnectionRequest, ReleaseAddressesResponse, AuditCrossBorderComplianceResponse, InquiryPriceResetVpnGatewayInternetMaxBandwidthRequest, DisableFlowLogsRequest, ReplaceSecurityGroupPolicyResponse, EnableGatewayFlowMonitorRequest, ModifyPrivateIpAddressesAttributeResponse, DeleteCdcNetPlanesRequest, ModifyHaVipAttributeResponse, CreateVpcPeeringConnectionResponse, DescribeCrossBorderCcnRegionBandwidthLimitsResponse, ReturnNormalAddressesRequest, DeleteSecurityGroupResponse, DeleteNetworkAclEntriesResponse, DescribeCdcLDCXListRequest, UpdateTrafficMirrorDirectionRequest, DisassociateHaVipInstanceResponse, CreateNetworkInterfaceResponse, DescribeAddressQuotaRequest, LockCcnsResponse, AssignIpv6AddressesResponse, CreateRoutesResponse, DescribeSecurityGroupsResponse, ModifyPrivateNatGatewayTranslationNatRuleRequest, CreateVpcEndPointServiceWhiteListRequest, DeleteNatGatewaySourceIpTranslationNatRuleRequest, ModifyVpnGatewayCcnRoutesRequest, DescribeGatewayFlowQosRequest, ReplaceDirectConnectGatewayCcnRoutesResponse, DownloadCustomerGatewayConfigurationResponse, ModifySecurityGroupPoliciesResponse, ModifyNatGatewayDestinationIpPortTranslationNatRuleRequest, DescribeServiceTemplatesRequest, ModifyPrivateNatGatewayTranslationNatRuleResponse, ResetTrafficMirrorTargetRequest, DetachNetworkInterfaceRequest, DescribeSnapshotAttachedInstancesResponse, AttachClassicLinkVpcResponse, DownloadVpnGatewaySslClientCertRequest, CreateAddressTemplateRequest, DescribeNatGatewaysResponse, ModifyTrafficMirrorAttributeRequest, ModifyDhcpIpAttributeResponse, CreatePrivateNatGatewayResponse, ModifyRouteTableSelectionPoliciesResponse, AttachNetworkInterfaceRequest, DescribeCcnRoutesResponse, DescribeVpcsResponse, UnlockCcnsResponse, DescribeRouteListRequest, DisableGatewayFlowMonitorResponse, ReplaceRoutesResponse, DisassociateAddressResponse, DescribeTrafficPackagesResponse, DescribeVpnGatewayRoutesRequest, GetCcnRegionBandwidthLimitsResponse, DeleteRoutesRequest, AssociateAddressRequest, DescribeAccountAttributesRequest, ModifyPrivateNatGatewayTranslationAclRuleResponse, ModifyCcnRouteTablesRequest, DescribeRoutePolicyEntriesRequest, ResetAttachCcnInstancesRequest, UnlockCcnBandwidthsResponse, ModifyVpnGatewaySslClientCertResponse, CreateDefaultSecurityGroupResponse, DeleteLocalGatewayResponse, DescribeHighPriorityRouteTablesRequest, DisableGatewayFlowMonitorRequest, ModifyNetworkInterfaceAttributeRequest, DescribeTrafficQosPolicyResponse, ModifyTemplateMemberResponse, ModifyHaVipAttributeRequest, ModifyAddressTemplateGroupAttributeResponse, DetachClassicLinkVpcResponse, UnassignPrivateIpAddressesRequest, DeleteVpnGatewayRoutesRequest, DescribeProductQuotaRequest, ModifyNetDetectResponse, CreateHaVipRequest, EnableFlowLogsResponse, DeletePrivateNatGatewayTranslationAclRuleRequest, DescribeAddressQuotaResponse, DescribePrivateNatGatewayLimitsRequest, CreateCustomerGatewayRequest, DeleteGlobalRoutesResponse, CreateTrafficMirrorRequest, CreateIp6TranslatorsRequest, DescribeCrossBorderCcnRegionBandwidthLimitsRequest, ReplaceCcnRouteTableBroadcastPolicysRequest, UnlockCcnsRequest, CreateRoutePolicyEntriesResponse, DescribeSnapshotAttachedInstancesRequest, DescribeDirectConnectGatewayCcnRoutesResponse, ModifyPrivateIpAddressesAttributeRequest, ResetNatGatewayConnectionResponse, DisassociateDirectConnectGatewayNatGatewayRequest, UpdateTrafficMirrorAllFilterResponse, AssociateNetworkInterfaceSecurityGroupsRequest, DeleteVpnGatewayRoutesResponse, DeleteHighPriorityRouteTablesResponse, CreateSecurityGroupRequest, ModifyCcnAttributeResponse, DescribeSecurityGroupLimitsRequest, DescribeClassicLinkInstancesRequest, ReleaseIp6AddressesBandwidthRequest, CreateServiceTemplateResponse, DeleteNetworkInterfaceResponse, DisableCcnRoutesResponse, DescribeCcnRegionBandwidthLimitsRequest, InquiryPriceCreateVpnGatewayRequest, DescribeAddressBandwidthRangeRequest, CreateAssistantCidrResponse, DescribeAddressTemplatesRequest, CreateDhcpIpRequest, EnableRoutesRequest, DeleteTrafficPackagesResponse, DeleteCustomerGatewayRequest, LockCcnBandwidthsResponse, DescribeAddressTemplateGroupsResponse, WithdrawNotifyRoutesResponse, AcceptVpcPeeringConnectionRequest, CreateCdcNetPlanesRequest, CreatePrivateNatGatewayDestinationIpPortTranslationNatRuleResponse, DeleteTrafficMirrorRequest, ModifyCdcLDCXAttributeResponse, DescribeNetworkInterfacesResponse, DeleteNetworkAclResponse, DeleteNetworkAclQuintupleEntriesResponse, DescribeServiceTemplateGroupsRequest, CreateSecurityGroupWithPoliciesRequest, ReleaseAddressesRequest, CreateVpcRequest, DescribeSubnetResourceDashboardResponse, DeleteServiceTemplateRequest, DescribeSecurityGroupAssociationStatisticsRequest, NotifyRoutesResponse, EnableVpnGatewaySslClientCertResponse, ModifyGlobalRouteECMPAlgorithmRequest, RenewAddressesRequest, ModifyVpcEndPointServiceWhiteListResponse, DisassociateAddressRequest, DescribeCrossBorderFlowMonitorResponse, DescribeBandwidthPackageQuotaRequest, DeleteVpcResponse, InquiryPriceModifyAddressesBandwidthRequest, ModifyGlobalRouteECMPAlgorithmResponse, DisassociateHaVipInstanceRequest, ReplaceCcnRouteTableInputPolicysRequest, CreateRoutePolicyAssociationsResponse, AddTemplateMemberRequest, ModifyNetworkInterfaceAttributeResponse, DescribeVpcEndPointServiceWhiteListResponse, AcceptAttachCcnInstancesResponse, DescribeUsedIpAddressResponse, DescribeNetDetectsResponse, AuditCrossBorderComplianceRequest } from "./vpc_models";
/**
 * vpc client
 * @class
 */
...
2. 实例迁移前后，可能会出现该接口返回的巨帧状态前后不一致（需要检查迁移前后实例所在的宿主机是否都支持巨帧，一种可能的原因为实例迁移到了不支持巨帧的宿主机）。
     */
    DescribeInstanceJumbo(req: DescribeInstanceJumboRequest, cb?: (error: string, rep: DescribeInstanceJumboResponse) => void): Promise<DescribeInstanceJumboResponse>;
    /**
...
>
     ...
     */
    ReplaceRoutePolicyEntries(req: ReplaceRoutePolicyEntriesRequest, cb?: (error: string, rep: ReplaceRoutePolicyEntriesResponse) => void): Promise<ReplaceRoutePolicyEntriesResponse>;
    /**
...
接口。
     ...
     */
    DescribeRoutePolicyEntries(req: DescribeRoutePolicyEntriesRequest, cb?: (error: string, rep: DescribeRoutePolicyEntriesResponse) => void): Promise<DescribeRoutePolicyEntriesResponse>;
    /**
     * 本接口(DeleteRoutePolicyAssociations)用于删除路由接收策略绑定（路由接收策略对象和路由表的绑定关系）。
     */
    DeleteRoutePolicyAssociations(req: DeleteRoutePolicyAssociationsRequest, cb?: (error: string, rep: DeleteRoutePolicyAssociationsResponse) => void): Promise<DeleteRoutePolicyAssociationsResponse>;
    /**
...
>
     ...
     */
    MigrateBandwidthPackageResources(req: MigrateBandwidthPackageResourcesRequest, cb?: (error: string, rep: MigrateBandwidthPackageResourcesResponse) => void): Promise<MigrateBandwidthPackageResourcesResponse>;
    /**
...
* 创建安全组同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     */
    ModifyRoutePolicyAttribute(req: ModifyRoutePolicyAttributeRequest, cb?: (error: string, rep: ModifyRoutePolicyAttributeResponse) => void): Promise<ModifyRoutePolicyAttributeResponse>;
    /**
     ...
     */
    DeleteRoutePolicyEntries(req: DeleteRoutePolicyEntriesRequest, cb?: (error: string, rep: DeleteRoutePolicyEntriesResponse) => void): Promise<DeleteRoutePolicyEntriesResponse>;
    /**
...
* 删除私有网络是不可逆的操作，请谨慎处理。
     ...
     * 查询全局路由列表。
     */
    DescribeGlobalRoutes(req: DescribeGlobalRoutesRequest, cb?: (error: string, rep: DescribeGlobalRoutesResponse) => void): Promise<DescribeGlobalRoutesResponse>;
    /**
     ...
     */
    DescribeAddressTemplateInstances(req: DescribeAddressTemplateInstancesRequest, cb?: (error: string, rep: DescribeAddressTemplateInstancesResponse) => void): Promise<DescribeAddressTemplateInstancesResponse>;
    /**
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询[DescribeVpcTaskResult](https://cloud.tencent.com/document/api/215/59037)接口。
     ...
     */
    ResetRoutePolicyEntries(req: ResetRoutePolicyEntriesRequest, cb?: (error: string, rep: ResetRoutePolicyEntriesResponse) => void): Promise<ResetRoutePolicyEntriesResponse>;
    /**
...
>
     ...
     */
    ReplaceRoutePolicyAssociations(req: ReplaceRoutePolicyAssociationsRequest, cb?: (error: string, rep: ReplaceRoutePolicyAssociationsResponse) => void): Promise<ReplaceRoutePolicyAssociationsResponse>;
    /**
...
如有需要, 可以封禁任意限速实例, 可接入到内部运营系统
     ...
     */
    DisassociateHaVipInstance(req: DisassociateHaVipInstanceRequest, cb?: (error: string, rep: DisassociateHaVipInstanceResponse) => void): Promise<DisassociateHaVipInstanceResponse>;
    /**
...
>
     ...
     * 删除全局路由。
     */
    DeleteGlobalRoutes(req: DeleteGlobalRoutesRequest, cb?: (error: string, rep: DeleteGlobalRoutesResponse) => void): Promise<DeleteGlobalRoutesResponse>;
    /**
...
2. 支持批量删除同一个转换实例下的多个转换规则
     ...
     */
    DescribeServiceTemplateInstances(req: DescribeServiceTemplateInstancesRequest, cb?: (error: string, rep: DescribeServiceTemplateInstancesResponse) => void): Promise<DescribeServiceTemplateInstancesResponse>;
    /**
...
* 新建的网络ACL的入站和出站规则默认都是全部拒绝，在创建后通常您需要再调用ModifyNetworkAclEntries将网络ACL的规则设置为需要的规则。
     ...
     */
    CreateRoutePolicyAssociations(req: CreateRoutePolicyAssociationsRequest, cb?: (error: string, rep: CreateRoutePolicyAssociationsResponse) => void): Promise<CreateRoutePolicyAssociationsResponse>;
    /**
     * 删除SSL-VPN-SERVER 实例
     */
...
- 只有状态为 BIND 和 BIND_ENI 的 EIPv6 实例才能进行解绑操作。
     ...
     */
    DescribeServiceTemplateGroupInstances(req: DescribeServiceTemplateGroupInstancesRequest, cb?: (error: string, rep: DescribeServiceTemplateGroupInstancesResponse) => void): Promise<DescribeServiceTemplateGroupInstancesResponse>;
    /**
...
在对新建的NAT网关做其他操作前，需先确认此网关已被创建完成（DescribeNatGateway接口返回的实例State字段为AVAILABLE）。
     ...
     */
    CreateRoutePolicy(req: CreateRoutePolicyRequest, cb?: (error: string, rep: CreateRoutePolicyResponse) => void): Promise<CreateRoutePolicyResponse>;
    /**
...
>
     ...
     */
    DescribeAddressTemplateGroupInstances(req: DescribeAddressTemplateGroupInstancesRequest, cb?: (error: string, rep: DescribeAddressTemplateGroupInstancesResponse) => void): Promise<DescribeAddressTemplateGroupInstancesResponse>;
    /**
...
>
     ...
     */
    CreateGlobalRoutes(req: CreateGlobalRoutesRequest, cb?: (error: string, rep: CreateGlobalRoutesResponse) => void): Promise<CreateGlobalRoutesResponse>;
    /**
     * 重置高优路由表。
     */
...
- 如果网关有流量，但调用本接口没有返回数据，请在控制台对应网关详情页确认是否开启网关流量监控。
     */
    DescribeNatGatewayFlowMonitorDetail(req: DescribeNatGatewayFlowMonitorDetailRequest, cb?: (error: string, rep: DescribeNatGatewayFlowMonitorDetailResponse) => void): Promise<DescribeNatGatewayFlowMonitorDetailResponse>;
    /**
...
* 只有状态为 UNBIND 的 EIP 才能够被绑定。
     ...
     */
    ModifyGlobalRouteECMPAlgorithm(req: ModifyGlobalRouteECMPAlgorithmRequest, cb?: (error: string, rep: ModifyGlobalRouteECMPAlgorithmResponse) => void): Promise<ModifyGlobalRouteECMPAlgorithmResponse>;
    /**
     ...
     */
    CreateRoutePolicyEntries(req: CreateRoutePolicyEntriesRequest, cb?: (error: string, rep: CreateRoutePolicyEntriesResponse) => void): Promise<CreateRoutePolicyEntriesResponse>;
    /**
...
删除 NAT 网关后，系统会自动删除路由表中包含此 NAT 网关的路由项，同时也会解绑弹性公网IP（EIP）。
     ...
     * 修改全局路由。
     */
    ModifyGlobalRoutes(req: ModifyGlobalRoutesRequest, cb?: (error: string, rep: ModifyGlobalRoutesResponse) => void): Promise<ModifyGlobalRoutesResponse>;
    /**
     * 修改高优路由表属性
     */
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`DescribeVpcTaskResult`接口。
     ...
     */
    ResetRoutePolicyAssociations(req: ResetRoutePolicyAssociationsRequest, cb?: (error: string, rep: ResetRoutePolicyAssociationsResponse) => void): Promise<ResetRoutePolicyAssociationsResponse>;
    /**
