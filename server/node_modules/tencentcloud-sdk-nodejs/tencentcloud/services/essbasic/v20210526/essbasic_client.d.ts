...
**注意：该接口需要开通白名单，请联系客户经理开通后使用。**
     */
    ChannelDescribeSignFaceVideo(req: ChannelDescribeSignFaceVideoRequest, cb?: (error: string, rep: ChannelDescribeSignFaceVideoResponse) => void): Promise<ChannelDescribeSignFaceVideoResponse>;
    /**
...
- 对于整个应用下所有企业的查询，**不需要指定子客的唯一标识**，直接查询整个应用下所有子客企业的企业信息
     */
    DescribeChannelOrganizations(req: DescribeChannelOrganizationsRequest, cb?: (error: string, rep: DescribeChannelOrganizationsResponse) => void): Promise<DescribeChannelOrganizationsResponse>;
    /**
     * 支持企业进行批量初始化操作：
...
<li>对于渠道客户企业的查询，通过指定渠道企业的唯一标识(Agent.ProxyOrganizationId)来查询“子客账号”套餐消耗详情</li>
     ...
     */
    ChannelDescribeAccountBillDetail(req: ChannelDescribeAccountBillDetailRequest, cb?: (error: string, rep: ChannelDescribeAccountBillDetailResponse) => void): Promise<ChannelDescribeAccountBillDetailResponse>;
    /**
...
<li>对于整个应用下所有企业的查询，不需要指定子客的唯一标识，只需要传入渠道应用标识(Agent.AppId)直接查询整个应用下所有子客企业消耗详情</li>
     ...
     */
    ChannelDescribeBillUsageDetail(req: ChannelDescribeBillUsageDetailRequest, cb?: (error: string, rep: ChannelDescribeBillUsageDetailResponse) => void): Promise<ChannelDescribeBillUsageDetailResponse>;
    /**
     * 批量清理未认证的企业认证流程。
...
注意: `处方单等特殊场景专用，此接口为白名单功能，使用前请联系对接的客户经理沟通。`
     */
    ChannelRenewAutoSignLicense(req: ChannelRenewAutoSignLicenseRequest, cb?: (error: string, rep: ChannelRenewAutoSignLicenseResponse) => void): Promise<ChannelRenewAutoSignLicenseResponse>;
    /**
     * 通过此接口获取个人用户自动签的开通状态。
