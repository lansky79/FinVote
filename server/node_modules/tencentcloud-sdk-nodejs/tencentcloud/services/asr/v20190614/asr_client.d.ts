...
import { CreateCustomizationResponse, ModifyCustomizationStateRequest, CreateRecTaskResponse, UpdateAsrVocabResponse, DeleteAsrKeyWordLibResponse, CreateAsrKeyWordLibRequest, VoicePrintGroupVerifyRequest, GetCustomizationListResponse, CloseAsyncRecognitionTaskRequest, DeleteCustomizationResponse, GetCustomizationListRequest, SentenceRecognitionRequest, VoicePrintCountRequest, VoicePrintCompareResponse, SetVocabStateResponse, VoicePrintDeleteRequest, DescribeAsyncRecognitionTasksRequest, GetAsrKeyWordLibListResponse, VoicePrintEnrollResponse, CreateAsrKeyWordLibResponse, CreateAsyncRecognitionTaskRequest, GetAsrVocabRequest, DescribeTaskStatusResponse, DownloadAsrVocabResponse, ModifyCustomizationResponse, GetAsrVocabListRequest, VoicePrintUpdateRequest, DeleteAsrVocabRequest, UpdateAsrVocabRequest, CreateAsrVocabResponse, SentenceRecognitionResponse, DescribeAsyncRecognitionTasksResponse, GetAsrVocabListResponse, DownloadCustomizationRequest, GetAsrVocabResponse, UpdateAsrKeyWordLibRequest, GetUsageByDateResponse, VoicePrintDeleteResponse, DownloadCustomizationResponse, CreateRecTaskRequest, DownloadAsrVocabRequest, ModifyCustomizationRequest, VoicePrintVerifyResponse, GetModelInfoResponse, DescribeTaskStatusRequest, VoicePrintCompareRequest, DeleteCustomizationRequest, VoicePrintCountResponse, CloseAsyncRecognitionTaskResponse, VoicePrintGroupVerifyResponse, CreateCustomizationRequest, UpdateAsrKeyWordLibResponse, CreateAsyncRecognitionTaskResponse, GetAsrKeyWordLibListRequest, DeleteAsrVocabResponse, VoicePrintVerifyRequest, SetVocabStateRequest, CreateAsrVocabRequest, VoicePrintUpdateResponse, DeleteAsrKeyWordLibRequest, GetModelInfoRequest, ModifyCustomizationStateResponse, GetUsageByDateRequest, VoicePrintEnrollRequest } from "./asr_models";
/**
 * asr client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 查询用户用量
     */
    GetUsageByDate(req: GetUsageByDateRequest, cb?: (error: string, rep: GetUsageByDateResponse) => void): Promise<GetUsageByDateResponse>;
    /**
...
注意：调用该接口后，模型会自动训练。新建模型成功后，调用ModifyCustomizationState接口修改为上线状态，即可在识别请求中使用对应模型ID。
     ...
     */
    GetAsrKeyWordLibList(req: GetAsrKeyWordLibListRequest, cb?: (error: string, rep: GetAsrKeyWordLibListResponse) => void): Promise<GetAsrKeyWordLibListResponse>;
    /**
...
•   默认接口请求频率限制：30次/秒，如您有提高请求频率限制的需求，请[前往购买](https://buy.cloud.tencent.com/asr)。
     ...
     */
    UpdateAsrKeyWordLib(req: UpdateAsrKeyWordLibRequest, cb?: (error: string, rep: UpdateAsrKeyWordLibResponse) => void): Promise<UpdateAsrKeyWordLibResponse>;
    /**
...
<br>•   本地文件必须为UTF-8编码格式，每行仅添加一个词且不能包含标点和特殊字符。
     */
    CreateAsrKeyWordLib(req: CreateAsrKeyWordLibRequest, cb?: (error: string, rep: CreateAsrKeyWordLibResponse) => void): Promise<CreateAsrKeyWordLibResponse>;
    /**
     ...
     * 用户通过本接口进行关键词表的删除。
     */
    DeleteAsrKeyWordLib(req: DeleteAsrKeyWordLibRequest, cb?: (error: string, rep: DeleteAsrKeyWordLibResponse) => void): Promise<DeleteAsrKeyWordLibResponse>;
    /**
